const searchengle = {
    ...
    getters: {
        getCurrentSearchEngle: (state) => {
            return {
                interface: state.currentSearchEngle.searchInterface,
                href: state.currentSearchEngle.searchBtnHref,
                name: state.currentSearchEngle.searchBtnName
            };
        }
    },
    mutations: {
        updateCurrentEngle (state, payload) {
            console.log(payload);
            state.currentSearchEngle = {
                searchInterface: payload.url,
                searchBtnHref: payload.href,
                searchBtnName: payload.name
            };
        }
    },
    actions: {}
